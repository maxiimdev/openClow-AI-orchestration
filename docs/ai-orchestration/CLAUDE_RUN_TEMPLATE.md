...
2) Перед реализацией перечисли 3 ключевых правила, которые критичны именно для этой задачи.
3) Дай план выполнения.
4) Начинай реализацию только после явного согласования плана.
